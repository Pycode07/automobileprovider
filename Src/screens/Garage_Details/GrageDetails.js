        ...
        <View
          ...
          <View style={styles.commTextinput}>
            <TextInput
              ...
              value={form.addres}
              onChangeText={(text) => { setForm({ addres: text }) }}
              placeholderTextColor={COLOR.GREY}
            />
          </View>
          {
            validation.addres ? <View style={{ marginBottom: 5 }}>
              <Text style={{ color: 'red', fontSize: 13 }}>Please Enter correct Address...</Text>
            </View> : null
          }
        </View>
      </View>
        ...
        <View style={styles.city}>
          ...
          <View style={styles.textInpt}>
            <TextInput
              ...
              placeholderTextColor={COLOR.GREY}
              value={form.area}
              onChangeText={(text) => { setForm({ area: text }) }}
            />
          </View>
        </View>
        <View style={styles.city}>
          ...
          <View style={styles.textInpt}>
            <TextInput
              ...
              placeholderTextColor={COLOR.GREY}
              value={form.city}
              onChangeText={(text) => { setForm({ city: text }) }}
            />
          </View>
        </View>
        <View style={styles.city}>
          ...
          <View style={styles.textInpt}>
            <TextInput
              ...
              placeholderTextColor={COLOR.GREY}
              value={form.pinCode}
              onChangeText={(text) => { setForm({ pinCode: text }) }}
            />
          </View>
        </View>
      </View>
        ...
        <View
          ...
          <View style={styles.gragecheck}>
            <BouncyCheckbox
              ...
              onPress={() => { setForm({ owned: true, rented: false }) }}
              textStyle={{
                color: 'black',
          ...
          <View style={styles.gragecheck}>
            <BouncyCheckbox
              ...
              onPress={() => { setForm({ rented: true, owned: false }) }}
              textStyle={{
                color: 'black',
                textDecorationLine: 'none',
                fontSize: height / 50,
        ...
        <View
          ...
          <View style={styles.commTextinput}>
            <TextInput
              ...
              placeholderTextColor={COLOR.GREY}
              value={form.website}
              onChangeText={(text) => { setForm({ website: text }) }}
            />
          </View>
        </View>
      </View>
        ...
        <View style={styles.WebsideMAIN}>
          ...
          <View style={styles.webside}>
            <TextInput
              ...
              onChangeText={(text) => { setForm({ ownerName: text }) }}
            />
          </View>
        </View>
        <View style={styles.WebsideMAIN}>
