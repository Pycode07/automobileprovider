export const ImagePath = {
  ...
  //
  NEXT_ARROW: require('../assets/Images/nextArrow.jpg'),
  ...
  WALLET: require('../assets/Images/more/wallet.png'),
  WALLETMONEY: require('../assets/Images/more/walletMoney.png'),
  MONEY: require('../assets/Images/more/money.png'),
  CHECK: require('../assets/Images/Check.png'),
  UNCHECK: require('../assets/Images/checkmark.png'),
  ...
  PAN: require('../assets/Images/pan-front.jpg'),
  PAN_BACK: require('../assets/Images/pan-back.jpg'),

  NEXT_BTN: require('../assets/Splash/Next_btn.png'),
  BACK_BUTTON: require('../assets/Images/Backbutton.png'),
  LOGIN_PHONE: require('../assets/Images/phoneLogin.png'),
